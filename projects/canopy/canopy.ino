...
int lightMode = 3; // one less than we want bc interrupt runs at beginning apparently

#include "strip_functions.h"
int _num_led_cols = 8; // Number of columns of LEDs
int _num_led_rows = 30; // Number of pixels in each column
